...
class admin_categoriesview extends StatefulWidget {
  const admin_categoriesview({super.key});

  @override
  State<admin_categoriesview> createState() => _admin_categoriesviewState();
}

class _admin_categoriesviewState extends State<admin_categoriesview> {
  ...
  void initState() {
    super.initState();
    getcategory(); // Fetch addresses when screen loads
  }
                                        ...
                                        Row(
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => update_categoriesview(id: address[index]['id'])));
                                              },
                                            ),
                                            IconButton(
