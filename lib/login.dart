...
import 'package:homefoo_users/ADMIN/adminhome.dart';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (status == 'User Login is Successfully Completed') {
          ...
          var userType = responseData['data']['user_type'];
          ...
          print("userIddddddddddd: $userId");

          await storeUserId(userId, token);

          if (userType == "Admin") {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (context) => AdminHome()), // Navigate to Admin Page
            );
          } else {
            Navigator.push(
              context,
        ...
        body: SingleChildScrollView(
          child: Container(
            ...
            children: [
              ...
              SizedBox(
                  height:
                      50), // Adds spacing between the container and text fields
              Row(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                          borderSide: BorderSide(
                              color: const Color.fromARGB(255, 165, 165,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              Colors.white, // Facebook button color
                          shadowColor: Colors.grey, // Box shadow color
                          elevation: 5, // Elevation for box shadow
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(
